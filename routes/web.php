...
Route::get('tiketwisata/hapus/{id}', 'tiketwisata@hapus');
Route::get('wahana', 'wahanacontroller@view');
Route::get('wahana/hapus/{id}', 'wahanacontroller@hapus');
...
Route::get('restaurant/hapus/{id}', 'datarestaurantcontroller@hapus');
Route::post('simpan-karyawan', 'datakaryawancontroller@simpankaryawan');
Route::get('hotel', 'datahotelcontroller@view');
Route::get('hotel/hapus/{id}', 'datahotelcontroller@hapus');
...
Route::get('karyawan/hapus/{id}', 'datakaryawancontroller@hapus');
