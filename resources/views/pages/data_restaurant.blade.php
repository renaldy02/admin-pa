    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">Data Restaurant</h3>
                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            ...
                            <a href="{{url("tambah-restaurant")}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
												<span>
                                            ...
                                            <div class="m-dropdown__body">
                                                <div class="m-dropdown__content">
                                                    <ul class="m-nav">
                                                        ...
                                                        <li class="m-nav__item">
                                                            <a href="{{url('manajemen-user/add-user')}}"
                                                               class="m-nav__link">
                                                        ...
                                                        <li class="m-nav__item">
                                                            <a href="" data-toggle="modal" data-target="#m_role"
                                                               class="m-nav__link">
                                                                <i class="m-nav__link-icon flaticon-user-settings"></i>
                                                                <span class="m-nav__link-text">Roles Users</span>
                                                            </a>
                                                        </li>
                                                        <li class="m-nav__item">
                                                            <a href="" data-toggle="modal" data-target="#m_permission"
                                                               class="m-nav__link">
                                                                <i class="m-nav__link-icon flaticon-user-ok"></i>
                                                                <span class="m-nav__link-text">Roles Permission</span>
                                                            </a>
                                                        </li>
