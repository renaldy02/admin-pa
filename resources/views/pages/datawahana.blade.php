...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">Data wahana</h3>
            ...
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        ...
                        <a href="{{url("tambah-wahana")}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
                                <span>
            ...
            <div class="m-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>{{1}}</th>
                            <th>{{$item->nama_wahana}}</th>
                            <th><img style="width: 55px;" src="{{$item->gambar}}"></th>
                            <th>{{$item->created_at}}</th>
                            <th>{{$item->updated_at}}</th>
                            <th><a href="{{url('wahana/hapus/'.$item->id)}}"><button class="btn btn-danger btn-xs">Hapus</button></a></th>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
