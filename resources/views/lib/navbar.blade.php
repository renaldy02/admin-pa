                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="index.html" class="m-brand__logo-wrapper">
                            <img alt="" src="{{asset('files/icon/topejawa.png')}}" width="170px"/>
                        </a>
                    </div>
                ...
                <div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general m-stack--fluid">
                                                ...
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="#" class="m-nav__link">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{{asset('assets/app/media/img/flags/015-china.svg')}}">
																		</span>
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="#" class="m-nav__link">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{{asset('assets/app/media/img/flags/016-spain.svg')}}">
																		</span>
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="#" class="m-nav__link">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{{asset('assets/app/media/img/flags/017-germany.svg')}}">
																		</span>
                            ...
                            <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
                                <a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="{{asset(\Illuminate\Support\Facades\Auth::user()->foto)}}" class="m--img-rounded m--marginless" alt="" />
												</span>
                    ...
                    -->
                                                ...
                                                <div class="m-card-user__details">
                                                    <span class="m-card-user__name m--font-weight-500">{{\Illuminate\Support\Facades\Auth::user()->name}}</span>
                                            ...
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                     ...
                                                     document.getElementById('logout-form').submit();" {{ __('Logout') }} class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a>
                                                    </li>
